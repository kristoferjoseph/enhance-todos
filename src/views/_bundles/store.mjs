...
var dirtyProps = [];
var listeners = [];
var set = window && window.requestAnimationFrame ? window.requestAnimationFrame : setTimeout;
var cancel = window && window.cancelAnimationFrame ? window.cancelAnimationFrame : clearTimeout;
var timeout;
var handler = {
